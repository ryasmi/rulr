...
describe('checkThrow', function () {
    ...
    it('should return the given warning if an exception is thrown', function () {
        var error = function (data, ex) {
            return rulr.warn(data + " " + ex.message);
        };
...
describe('checkType', function () {
    it('should return the given warning if the constructor is incorrect', function () {
        var error = function (type) { return function (data) {
            return rulr.warn(data + " " + type);
        }; };
...
describe('checkRegex', function () {
    ...
    it('should return the given type warning if the data is not a string', function () {
...
describe('restrictToSchema', function () {
    ...
    it('should return the given key warning if keys are invalid', function () {
    ...
    it('should return the default object warning if data is not an object', function () {
        var rule = rulr.restrictToSchema(schema);
        assertRule(rule, 10, ['`10` is not a valid Object in `data`']);
    });
    it('should return the default key warning if keys are invalid', function () {
        var rule = rulr.restrictToSchema(schema);
...
describe('restrictToCollection', function () {
    ...
    it('should return the given array warning if data is not an array', function () {
    ...
    it('should return the default array warning if data is not an array', function () {
